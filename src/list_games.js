...
import { Blacklist, Games, Oddball_Players, Oddball, Players } from './dbObjects';
        ...
        client.on('message', async (message) => {
            ...
            if (message.content.startsWith(PREFIX)) {
                ...
                switch (CMD_NAME) {
                    ...
                    default:
                        return message.reply(`Unknown command: ${PREFIX}${CMD_NAME}. Use '${PREFIX}help' to see available commands.`);
                }
